...
upsert "$API_SERVICE_NAME" APPROVAL_ADMIN_EMAIL_FROM "Financieramente <onboarding@resend.dev>"
upsert "$API_SERVICE_NAME" APPROVAL_EMAIL_FROM "Financieramente <onboarding@updates.ug.uchile.cl>"
