...
export type TransactionsModalProps = {
  ...
  documentsParseProgress?: import('@/lib/transacciones/progreso-parse.helpers').DocumentsParseProgress | null;
  onDocumentsParseProgress?: (
    progress: import('@/lib/transacciones/progreso-parse.helpers').DocumentsParseProgress,
  ) => void;
  transactionUploadError?: string | null;
  saveTransactionProductForBatch: () => boolean;
