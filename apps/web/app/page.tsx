...
const FEATURES = [
  {
    ...
    desc: 'Analiza ingresos, gastos, deudas y metas. En minutos tenés una radiografía honesta de tu situación.',
    color: '#6f8fa6',
  },
  {
    num: '02',
    ...
    desc: 'Preguntá como hablarías con un asesor real. Sin formularios, sin hojas de cálculo, sin tecnicismos.',
    color: '#8a9f78',
  },
  {
    num: '03',
    ...
    desc: 'Recibís recomendaciones concretas y un informe descargable adaptado a tu perfil y objetivos.',
    color: '#a48f4f',
  },
];
...
const STEPS = [
  {
    num: '01',
    title: 'Contá tu situación',
    desc: 'Respondés un cuestionario breve sobre ingresos, deudas, gastos y metas. 10 minutos, sin hojas de cálculo.',
    dot: '#6f8fa6',
  ...
  {
    num: '03',
    title: 'Recibís claridad',
    desc: 'Conversás con el agente, simulás escenarios y descargás tu plan de acción en PDF.',
    dot: '#a48f4f',
...
const CHAT_MESSAGES = [
  ...
  {
    from: 'ai' as const,
    text: 'Con base en tu perfil: ingreso $1.2M, gastos fijos $820K. Ajustando cuotas, podés ahorrar un 18% mensual sin sacrificar calidad de vida.',
  },
      ...
      >
        {PAIN_POINTS.map(({ text, sub }) => (
          <motion.div key={text} variants={fadeLeft}>
            ...
            <p style={{ fontSize: 14, color: 'rgba(255,255,255,0.30)', lineHeight: 1.5 }}>{sub}</p>
          </motion.div>
        ))}
      </motion.div>
    </section>
    ...
    >
      <div
        style={{
          ...
          maxHeight: 700,
          borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(111,143,166,0.05) 0%, transparent 70%)',
          pointerEvents: 'none',
        }}
      />
          ...
          >
            ...
            <div
              style={{
                ...
                height: 42,
                borderRadius: 13,
                background: `rgba(${color === '#6f8fa6' ? '111,143,166' : color === '#8a9f78' ? '138,159,120' : '164,143,79'},0.13)`,
                display: 'flex',
                alignItems: 'center',
            ...
            <h3 style={{ fontSize: 16, fontWeight: 700, color: 'rgba(255,255,255,0.90)', margin: '0 0 8px', lineHeight: 1.3 }}>
              {title}
            </h3>
...
function StepsSection() {
  ...
  return (
    <section
      ref={ref}
      style={{ background: '#0b0d11', padding: 'clamp(80px, 10vw, 140px) clamp(24px, 6vw, 80px)' }}
    >
      <motion.p
        initial={{ opacity: 0 }}
        animate={inView ? { opacity: 1 } : {}}
        ...
        {STEPS.map(({ num, title, desc, dot, ring }, i) => (
          ...
          >
            <div style={{ flexShrink: 0, display: 'flex', alignItems: 'center', paddingTop: 6 }}>
              <div
                style={{
                  ...
                  position: 'relative',
                  zIndex: 1,
                  boxShadow: `0 0 0 4px #0b0d11, 0 0 0 5px ${ring}`,
                }}
              />
            </div>
            ...
            <div style={{ flex: 1 }}>
              ...
              <p style={{ fontSize: 14, color: 'rgba(255,255,255,0.36)', lineHeight: 1.65, margin: '0 0 18px', maxWidth: 480 }}>
                {desc}
              </p>
            </div>
          </motion.div>
      ...
      <motion.button
        ...
        style={{
          ...
          gap: 7,
          borderRadius: 999,
          border: '1px solid rgba(164,143,79,0.3)',
          background: 'rgba(164,143,79,0.08)',
          padding: '10px 22px',
          fontSize: 13,
          fontWeight: 600,
          color: 'rgba(164,143,79,0.9)',
          cursor: 'pointer',
        }}
      >
  ...
  return (
    ...
    >
      <motion.p
        ...
        animate={inView ? { opacity: 1 } : {}}
        transition={{ duration: 0.5 }}
        style={{ fontSize: 11, letterSpacing: '0.18em', color: '#6f8fa6', textTransform: 'uppercase', marginBottom: 14, fontWeight: 600, textAlign: 'center' }}
      >
        El agente en acción
      </motion.p>
        ...
        <div style={{ padding: '20px 16px', display: 'flex', flexDirection: 'column', gap: 10 }}>
          {CHAT_MESSAGES.map((msg, i) => (
            <motion.div
              ...
              animate={inView ? { opacity: 1, y: 0 } : {}}
              transition={{ duration: 0.45, delay: 0.7 + i * 0.7, ease: EASE }}
            ...
            >
              <div
                style={{
                  ...
                  background: msg.from === 'user' ? 'rgba(111,143,166,0.16)' : 'rgba(255,255,255,0.05)',
                  border: `1px solid ${msg.from === 'user' ? 'rgba(111,143,166,0.22)' : 'rgba(255,255,255,0.05)'}`,
                  fontSize: 13,
                  lineHeight: 1.55,
                  color: msg.from === 'user' ? 'rgba(255,255,255,0.78)' : 'rgba(255,255,255,0.58)',
                }}
              >
                {msg.text}
              </div>
...
function TrustSection() {
  ...
  return (
    <section
      ref={ref}
      style={{ background: '#0b0d11', padding: 'clamp(64px, 8vw, 100px) clamp(24px, 6vw, 80px)' }}
    >
      <motion.div
        variants={staggerFast}
        initial="hidden"
          ...
          <motion.div key={label} variants={fadeUp} style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            <div
              style={{
                ...
                height: 38,
                borderRadius: 11,
                background: 'rgba(111,143,166,0.09)',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
              }}
            ...
            <h4 style={{ fontSize: 15, fontWeight: 700, color: 'rgba(255,255,255,0.82)', margin: 0 }}>{label}</h4>
            <p style={{ fontSize: 13, color: 'rgba(255,255,255,0.32)', lineHeight: 1.55, margin: 0 }}>{sub}</p>
          </motion.div>
        ))}
      </motion.div>
      ...
      <motion.div
        ...
        style={{ height: 1, background: 'rgba(255,255,255,0.06)', marginBottom: 36, transformOrigin: 'left' }}
      />
...
function CtaSection() {
  ...
  return (
    <section
      ref={ref}
      style={{
        background: 'linear-gradient(to bottom, #060810, #0a0e1a)',
    ...
    >
      <div
        style={{
          ...
          maxHeight: 500,
          borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(111,143,166,0.06) 0%, transparent 70%)',
          pointerEvents: 'none',
        }}
      />
      ...
      >
        ...
        <div style={{ position: 'relative', zIndex: 10, display: 'flex', minHeight: '100dvh', flexDirection: 'column' }}>
          ...
          <div className="home-page-header">
            ...
            >
              <div style={{ width: 30, height: 30, flexShrink: 0, borderRadius: 6, overflow: 'hidden', boxShadow: '0 8px 20px rgba(0,0,0,0.22)' }}>
                <Image src="/logo-financieramente.jpg" alt="Financieramente" width={30} height={30} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
              </div>
          ...
          <motion.section className="home-page-hero" style={{ y: heroContentY, opacity: heroOpacity }}>
            ...
            >
              ...
              />
              <span style={{ fontSize: 11, fontWeight: 600, color: 'rgba(111,167,188,0.88)', letterSpacing: '0.05em' }}>
          ...
          {/* Scroll indicator */}
          <motion.div
            style={{ opacity: scrollArrowOpacity, display: 'flex', justifyContent: 'center', paddingBottom: 20, zIndex: 10 }}
          >
            <motion.div
              animate={{ y: [0, 8, 0] }}
